...
TEST_CASE(static_check_failed){
    TEST_STATIC_CHECK(-1==0);TEST_STATIC_CHECK(-1==1);
    TEST_STATIC_CHECK(-1==2);
    TEST_STATIC_CHECK_NOT(0==0);TEST_STATIC_CHECK(1==1);
    TEST_STATIC_CHECK(2==2);
}

TEST_STATIC_CHECK(-1==3);TEST_STATIC_CHECK(-1==4);
TEST_STATIC_CHECK(-1==5);
TEST_STATIC_CHECK_NOT(3==3);TEST_STATIC_CHECK_NOT(4==4);
TEST_STATIC_CHECK_NOT(5==5);
